package com.alienpants.leafpicrevived2.adapters;
...
import com.alienpants.leafpicrevived2.CardViewStyle;
...
import com.alienpants.leafpicrevived2.data.sort.AlbumsComparators;
...
public class AlbumsAdapter extends ThemedAdapter<AlbumsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final AlbumsAdapter.ViewHolder holder, int position) {
        ...
        RequestOptions options = new RequestOptions()
                ...
                .error(com.alienpants.leafpicrevived2.R.drawable.ic_error)
