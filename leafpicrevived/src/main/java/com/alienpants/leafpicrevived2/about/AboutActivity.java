...
import com.alienpants.leafpicrevived2.util.ChromeCustomTabs;
...
import static com.alienpants.leafpicrevived2.util.ServerConstants.GITHUB_CALVIN;
import static com.alienpants.leafpicrevived2.util.ServerConstants.GITHUB_DONALD;
import static com.alienpants.leafpicrevived2.util.ServerConstants.GITHUB_LEAFPIC;
import static com.alienpants.leafpicrevived2.util.ServerConstants.GITHUB_TOM;
import static com.alienpants.leafpicrevived2.util.ServerConstants.GOOGLE_ABOUT_CALVIN;
import static com.alienpants.leafpicrevived2.util.ServerConstants.LEAFPIC_CROWDIN;
import static com.alienpants.leafpicrevived2.util.ServerConstants.LEAFPIC_ISSUES;
import static com.alienpants.leafpicrevived2.util.ServerConstants.LEAFPIC_LICENSE;
import static com.alienpants.leafpicrevived2.util.ServerConstants.MAIL_CALVIN;
import static com.alienpants.leafpicrevived2.util.ServerConstants.MAIL_DONALD;
import static com.alienpants.leafpicrevived2.util.ServerConstants.MAIL_GILBERT;
import static com.alienpants.leafpicrevived2.util.ServerConstants.MAIL_TOM;
import static com.alienpants.leafpicrevived2.util.ServerConstants.TWITTER_ABOUT_DONALD;
import static com.alienpants.leafpicrevived2.util.ServerConstants.TWITTER_ABOUT_GILBERT;
