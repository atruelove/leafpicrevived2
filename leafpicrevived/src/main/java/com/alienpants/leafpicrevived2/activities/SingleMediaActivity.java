...
import com.alienpants.leafpicrevived2.adapters.MediaPagerAdapter;
import com.alienpants.leafpicrevived2.animations.SlidePageTransformer;
import com.alienpants.leafpicrevived2.data.Album;
import com.alienpants.leafpicrevived2.data.AlbumSettings;
import com.alienpants.leafpicrevived2.data.Media;
import com.alienpants.leafpicrevived2.data.MediaHelper;
import com.alienpants.leafpicrevived2.data.StorageHelper;
import com.alienpants.leafpicrevived2.data.filter.MediaFilter;
import com.alienpants.leafpicrevived2.data.provider.CPHelper;
import com.alienpants.leafpicrevived2.data.sort.MediaComparators;
import com.alienpants.leafpicrevived2.fragments.BaseMediaFragment;
import com.alienpants.leafpicrevived2.fragments.ImageFragment;
...
import com.alienpants.leafpicrevived2.util.Measure;
...
import com.alienpants.leafpicrevived2.views.HackyViewPager;
...
//        mViewPager.setPageTransformer(true, AnimationUtils.getPageTransformer(new DepthPageTransformer()));
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (isSlideShowOn) {
            ...
            menu.findItem(R.id.slide_show).setIcon(getToolbarIcon(CommunityMaterial.Icon2.cmd_stop_circle_outline));
        } else {
            ...
            menu.findItem(R.id.action_rotate).setIcon(getToolbarIcon(CommunityMaterial.Icon2.cmd_rotate_right));
            menu.findItem(R.id.rotate_right_90).setIcon(getToolbarIcon(CommunityMaterial.Icon2.cmd_rotate_right).color(IconicsColor.colorInt(getIconColor())));
            menu.findItem(R.id.rotate_left_90).setIcon(getToolbarIcon(CommunityMaterial.Icon2.cmd_rotate_left).color(IconicsColor.colorInt(getIconColor())));
            menu.findItem(R.id.rotate_180).setIcon(getToolbarIcon(CommunityMaterial.Icon2.cmd_rotate_left).color(IconicsColor.colorInt(getIconColor())));
        }
        return true;
    }
