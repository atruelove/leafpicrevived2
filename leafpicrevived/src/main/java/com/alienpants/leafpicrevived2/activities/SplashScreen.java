...
public class SplashScreen extends SharedMediaActivity {
    ...
    public void setNavBarColor() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setStatusBarColor(ColorPalette.getTransparentColor(
                    ContextCompat.getColor(getApplicationContext(), com.alienpants.leafpicrevived2.R.color.md_black_1000), 70));
        }
    }
    ...
    public void updateUiElements() {
        ...
        findViewById(com.alienpants.leafpicrevived2.R.id.Splah_Bg).setBackgroundColor(getBackgroundColor());
    }
}
