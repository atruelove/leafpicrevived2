...
import com.alienpants.leafpicrevived2.views.videoplayer.CustomExoPlayerView;
import com.alienpants.leafpicrevived2.views.videoplayer.CustomPlayBackController;
import com.alienpants.leafpicrevived2.views.videoplayer.TrackSelectionHelper;
...
//            case C.TYPE_HLS:return new HlsMediaSource(uri, mediaDataSourceFactory, mainHandler, null);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(com.alienpants.leafpicrevived2.R.menu.menu_video_player, menu);
