...
import com.alienpants.leafpicrevived2.BuildConfig;
import com.alienpants.leafpicrevived2.R;
import com.alienpants.leafpicrevived2.about.AboutActivity;
...
import com.alienpants.leafpicrevived2.fragments.AlbumsFragment;
import com.alienpants.leafpicrevived2.fragments.EditModeListener;
import com.alienpants.leafpicrevived2.fragments.NothingToShowListener;
import com.alienpants.leafpicrevived2.fragments.RvMediaFragment;
import com.alienpants.leafpicrevived2.interfaces.MediaClickListener;
import com.alienpants.leafpicrevived2.timeline.TimelineFragment;
import com.alienpants.leafpicrevived2.util.AlertDialogsHelper;
import com.alienpants.leafpicrevived2.util.DeviceUtils;
import com.alienpants.leafpicrevived2.util.LegacyCompatFileProvider;
...
import static com.alienpants.leafpicrevived2.views.navigation_drawer.NavigationDrawer.ItemListener;
import static com.alienpants.leafpicrevived2.views.navigation_drawer.NavigationDrawer.NAVIGATION_ITEM_ABOUT;
import static com.alienpants.leafpicrevived2.views.navigation_drawer.NavigationDrawer.NAVIGATION_ITEM_ALL_ALBUMS;
import static com.alienpants.leafpicrevived2.views.navigation_drawer.NavigationDrawer.NAVIGATION_ITEM_ALL_MEDIA;
//import static com.alienpants.leafpicrevived2.views.navigation_drawer.NavigationDrawer.NAVIGATION_ITEM_DONATE;
import static com.alienpants.leafpicrevived2.views.navigation_drawer.NavigationDrawer.NAVIGATION_ITEM_HIDDEN_FOLDERS;
import static com.alienpants.leafpicrevived2.views.navigation_drawer.NavigationDrawer.NAVIGATION_ITEM_SETTINGS;
import static com.alienpants.leafpicrevived2.views.navigation_drawer.NavigationDrawer.NAVIGATION_ITEM_WALLPAPERS;
import static com.alienpants.leafpicrevived2.views.navigation_drawer.NavigationDrawer.NavigationItem;
...
public class MainActivity extends SharedMediaActivity implements
    ...
    private void setupFAB() {
        fab.setImageDrawable(new IconicsDrawable(getApplicationContext()).icon(GoogleMaterial.Icon.gmd_camera_alt).color(IconicsColor.colorInt(Color.WHITE)));
