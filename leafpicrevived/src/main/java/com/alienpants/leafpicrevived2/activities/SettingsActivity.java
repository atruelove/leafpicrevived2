...
import com.alienpants.leafpicrevived2.settings.CardViewStyleSetting;
import com.alienpants.leafpicrevived2.settings.ColorsSetting;
import com.alienpants.leafpicrevived2.settings.GeneralSetting;
import com.alienpants.leafpicrevived2.settings.MapProviderSetting;
import com.alienpants.leafpicrevived2.settings.SinglePhotoSetting;
import com.alienpants.leafpicrevived2.util.Security;
import com.alienpants.leafpicrevived2.views.SettingWithSwitchView;
...
public class SettingsActivity extends BaseActivity {
    ...
    public void updateUiElements() {
        ...
        findViewById(com.alienpants.leafpicrevived2.R.id.setting_background).setBackgroundColor(getBackgroundColor());
        setStatusBarColor();
        setNavBarColor();
        setRecentApp(getString(com.alienpants.leafpicrevived2.R.string.settings));
    }
