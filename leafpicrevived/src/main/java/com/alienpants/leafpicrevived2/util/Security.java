...
public class Security {
    ...
    public static void authenticateUser(final ThemedActivity activity, final AuthCallBack passwordInterface) {
        ...
        final View view = activity.getLayoutInflater().inflate(com.alienpants.leafpicrevived2.R.layout.dialog_password, null);
        final TextView passwordDialogTitle = view.findViewById(com.alienpants.leafpicrevived2.R.id.password_dialog_title);
        final CardView passwordDialogCard = view.findViewById(com.alienpants.leafpicrevived2.R.id.password_dialog_card);
        final EditText editTextPassword = view.findViewById(com.alienpants.leafpicrevived2.R.id.password_edittxt);
